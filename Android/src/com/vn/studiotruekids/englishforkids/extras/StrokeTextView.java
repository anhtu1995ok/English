package com.vn.studiotruekids.englishforkids.extras;
...
public class StrokeTextView extends Button {
    ...
    public StrokeTextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if(attrs != null) {
            ...
            _strokeColor = a.getColor(R.styleable.StrokeTextAttrs_textStrokeColor,
                    getCurrentTextColor());         
            _strokeWidth = a.getFloat(R.styleable.StrokeTextAttrs_textStrokeWidth,
